...
import { invalidateCatalogCache } from '../src/app.js'
import { buildTestApp } from '../src/tests/helpers.ts'
...
// Сигнатура buildApp после сборки — объект опций (сессии, почта, антиспам),
// поэтому поднимаем через общий хелпер, а не собственным вызовом.
